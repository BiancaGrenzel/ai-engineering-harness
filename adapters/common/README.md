...
- Merging Profile defaults from `.harness/` content (preferred), legacy root pack, or the content pack
- Resolving Rule / Skill identifiers to content paths
- Resolving Tool identifiers via `tools/registry.yaml`
